# Ark Snack Shop - Tacos
This project originally provided by Major League Hackathon (MLH). Modifications were made to simplify and adapt the project for the undergraduate students at San Jose State University, so that they could play around with Blockchain. No copyright - this project is for everyone, just like its predecessor at MLH.
